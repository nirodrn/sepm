  ...
  async recordStockMovement(movementData) {
    try {
      ...
      if (movementData.materialType === 'rawMaterial') {
        await this.updateRawMaterialStock(movementData.materialId, movementData.quantity, movementData.type);
      } else if (movementData.materialType === 'packingMaterial') {
        await this.updatePackingMaterialStock(movementData.materialId, movementData.quantity, movementData.type);
      }
