  ...
  const materialTypes = [
    {
      ...
      category: 'raw',
      description: 'Main ingredients used in production',
      status: 'active',
    ...
    },
    {
      ...
      category: 'raw',
      description: 'Supporting ingredients for production',
      status: 'active',
      createdAt: '2025-01-10'
    },
    {
      ...
      category: 'packing',
      description: 'Direct product packaging materials',
      status: 'active',
      createdAt: '2025-01-10'
    },
    {
      ...
      category: 'packing',
      description: 'Outer packaging and shipping materials',
      status: 'active',
      createdAt: '2025-01-10'
    },
    {
      ...
      name: 'Additive',
      category: 'raw',
      description: 'Chemical additives and enhancers',
      status: 'active',
